...
8. (**9**) **Clear the transient tables** (this also closes the re-entry window), then `emit BatchPosted(batch.rollupIdsWithProofSystems.length, sharedPublicInput)`.
